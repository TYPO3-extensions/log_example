 ...
 *
 */
class Tx_LogExample_Demonstration_Usage_Basic extends Tx_LogExample_Demonstration_Usage_Abstract {
	...
	static public function execute() {
		...
		$logger->log(\TYPO3\CMS\Core\Log\LogLevel::WARNING, $message);
