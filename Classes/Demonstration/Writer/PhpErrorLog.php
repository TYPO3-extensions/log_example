...
/**
 * Demonstrating the PhpErrorLog writer of the TYPO3 Logging API
 *
 */
class Tx_LogExample_Demonstration_Writer_PhpErrorLog {
	...
	static public function execute() {
		...
		$message = 'A debug message written to PHP error_log()';
